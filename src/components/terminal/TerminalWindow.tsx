...
export type TerminalWindowProps = {
  title: string;
  statusDot?: "red" | "yellow" | "green" | "ink" | "off";
  statusLabel?: string;
  children: ReactNode;
  className?: string;
...
/**
 * macOS-style window frame. Used everywhere for content containers so
 * the app reads as a stack of terminal / document panes.
 */
