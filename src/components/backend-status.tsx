...
/**
 * Inline status pill — pings /health once on mount. If the response
 * takes longer than COLD_THRESHOLD_MS it warns the user the backend is
 * likely waking from a Render cold start (adds ~20s to the first
 * fingerprint request).
 */
